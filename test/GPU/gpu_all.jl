...
@test PreallocationTools._parameterless_type(cache_CU.dual_du) ==
    PreallocationTools._parameterless_type(u0_CU) # check that dual cache storage stays on the GPU.
